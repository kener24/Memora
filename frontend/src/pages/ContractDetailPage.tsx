...
type Tab = "summary" | "services" | "conditions" | "installments" | "payments" | "history";
...
export function ContractDetailPage() {
  ...
  return <div className="module-page contract-detail-page">
    ...
    {tab === "payments" && <ContractPaymentsTab contract={contract} />}
